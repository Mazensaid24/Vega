...
async def ihd(client: Client, message: Message):
    ...
    await client.send_photo(message.chat.id,url,caption="- Join.Channel.SouRce : @SourceOlivea ⋅",
...
async def ihd(client: Client, message: Message):
    ...
    await client.send_audio(message.chat.id,url,caption="- Join.Channel.SouRce : @SourceOlivea ⋅",
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
