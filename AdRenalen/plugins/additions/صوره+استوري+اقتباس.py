...
async def ihd(client: Client, message: Message):
    ...
    await client.send_photo(message.chat.id,url,caption="- Join.Channel.SouRce : @Vega_Source ⋅",
...
async def ihd(client: Client, message: Message):
    ...
    await client.send_audio(message.chat.id,url,caption="- Join.Channel.SouRce : @Vega_Source ⋅",
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
