...
async def init():
    ...
    await Omar.start()
    try:
        await Omar.stream_call("https://te.legra.ph/file/37d163a2f75e0d3b403d6.jpg")
    ...
    LOGGER("AdRenalen").info("Dev.SuoRce @ZzZzZl1l The.SouRce.AdRenalen @Vega_Source @miika3"
            )
    await idle()
    await app.stop()
    await userbot.stop()
